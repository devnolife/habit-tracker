      ...
      <View className="flex-row items-center justify-between">
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            { backgroundColor: `${dzikir.color}15` },
          ]}
        >
        ...
        >
          ...
          <View className="px-6 mt-4">
            ...
            >
              <View className="flex-row items-center justify-between">
                <View>
                  <Text className="text-violet-200 text-sm font-medium mb-1">
            ...
            {DZIKIR_CATEGORIES.map((cat) => (
              <TouchableOpacity
                ...
                className={`px-4 py-3 rounded-2xl flex-row items-center gap-2 ${
                  selectedCategory === cat.id ? 'bg-emerald-500' : 'bg-white'
                }`}
                style={
          ...
          <View className="mx-6 mt-4">
            ...
            >
              <View className="flex-row items-center gap-3">
                ...
                <View className="flex-1">
                  <Text className="text-sm font-bold text-violet-800 mb-0.5">
